...
def generate_input(params):
    """Generate random test input for largest digit problem."""
    # Generate a random integer n where |n| ≤ 10¹⁸
    max_abs = 10**18
    n = random.randint(-max_abs, max_abs)
    return str(n)
...
def main():
    parser = argparse.ArgumentParser(description="Generate test cases for largest digit problem.")
    ...
    parser.add_argument("--output-dir", default="csln_tests", help="Output directory")
